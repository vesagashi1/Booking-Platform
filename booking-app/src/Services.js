...
function ServicesPage() {
  return (
    <div className="services-page font-sans relative min-h-screen flex flex-col items-center justify-center">
      ...
      <div className="content-container relative z-10 text-white text-center">
